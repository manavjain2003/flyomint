        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-6">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-bold text-gray-900 dark:text-gray-100">GST Details{mandatory ? " *" : " (Optional)"}</h3>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full h-10 rounded-lg border px-3 text-sm text-gray-900 dark:text-gray-100 uppercase outline-none focus:border-[#1c8fc7] ${
                                gstError ? "border-red-400" : "border-gray-200 dark:border-gray-700"
                            }`}
                        />
                        {gstError && <p className="text-[11px] text-red-500 dark:text-red-400 mt-1">{gstError}</p>}
                    </div>
                    <div>
                        <label className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1 block">
                            Company Name *
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full h-10 rounded-lg border px-3 text-sm text-gray-900 dark:text-gray-100 outline-none focus:border-[#1c8fc7] ${
                                emailError ? "border-red-400" : "border-gray-200 dark:border-gray-700"
                            }`}
                        />
                        {emailError && <p className="text-[11px] text-red-500 dark:text-red-400 mt-1">{emailError}</p>}
                    </div>
                    <div>
                        <label className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1 block">
                            Registered Address
