            ...
            <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">View and manage your flight history</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="inline-flex rounded-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 p-1 gap-1 mb-6">
                            {TABS.map((tab) => (
                                <button
                                    key={tab.key}
                                    type="button"
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 min-h-[380px]">
                            {filteredBookings.length === 0 ? (
                                <div className="flex flex-col items-center justify-center text-center py-24 px-6">
                                    <span className="grid place-items-center w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-800 mb-5">
                                        <HiOutlinePaperAirplane className="w-6 h-6 text-gray-400 dark:text-gray-500 -rotate-45" />
                                    </span>
                                    <p className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">
                                        {emptyCopy[activeTab].title}
                                    </p>
                                    <p className="text-sm text-gray-500 dark:text-gray-400">{emptyCopy[activeTab].subtitle}</p>
                                </div>
                            ) : (
