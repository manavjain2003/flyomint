        ...
        <section className="bg-dark dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                <div className="flex items-end justify-between mb-8 gap-4">
                    ...
                    <button
                        type="button"
                        className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-4 py-2 text-sm font-semibold text-gray-900 dark:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shrink-0"
                    >
                        All questions
                        ...
                        return (
                            <div key={faq.question}>
                                <button
                                    ...
                                    className="w-full flex items-center justify-between gap-4 text-left px-6 py-5 hover:bg-gray-50/60 dark:hover:bg-gray-800/60 transition-colors"
                                >
                                    ...
                                    {isOpen ? (
                                        ...
                                        <HiOutlineChevronDown className="w-4 h-4 text-gray-400 dark:text-gray-500 shrink-0" />
                                    )}
                                </button>
                ...
                <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <a
                        href="#"
                        className="group flex items-center justify-between gap-4 bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 px-6 py-5 hover:border-gray-300 dark:hover:border-gray-600 hover:shadow-sm transition"
                    >
                        <div>
                            <p className="text-[15px] font-semibold text-gray-900 dark:text-gray-100">5+ more answers</p>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Browse our full knowledge base.</p>
                        </div>
                        <HiOutlineArrowRight className="w-4 h-4 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 shrink-0" />
                    </a>
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Help center — real 24×7 support.</p>
                            </div>
                        </div>
                        <HiOutlineArrowRight className="w-4 h-4 text-gray-400 dark:text-gray-500 group-hover:text-gray-600 shrink-0" />
                    </a>
