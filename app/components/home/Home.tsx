...
const [hoveredFare, setHoveredFare] = useState<SpecialFare | null>(null);
    ...
    <div className="absolute inset-x-0 bottom-0 h-[35%]  bg-gradient-to-b from-white/0 dark:from-gray-900/0 via-white/30 dark:via-gray-900/30 to-white/70 dark:to-gray-900/70" />
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 -mt-28 sm:-mt-32 pb-16">
                <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl p-8 sm:p-10 lg:p-14 min-h-[420px]">
        ...
        Round Trip
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-end gap-5">
                        <div className="relative w-full lg:flex-1 lg:min-w-0" ref={fromRef}>
                            <Field label="From" onClick={() => setFromOpen(true)} active={fromOpen}>
                                <input
                                    ...
                                    placeholder="From"
                                    className="w-full bg-transparent text-base font-semibold text-gray-900 dark:text-gray-100 outline-none placeholder:text-gray-400 dark:placeholder:text-gray-500 placeholder:font-medium"
                                />
                            </Field>
                        ...
                        <button
                            ...
                            className="hidden lg:grid place-items-center w-9 h-9 rounded-full border border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:text-[#FF7626] hover:border-[#FF7626] transition self-center mb-2.5 shrink-0 mt-8"
                        >
                                ...
                                customInput={
                                    <Field label="Departure">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <HiOutlineCalendar className="w-5 h-5 text-gray-400 dark:text-gray-500" />
                                        </div>
                                    </Field>
                                }
                            />
   ...
   <DatePicker
    ...
    customInput={
        <Field label="Return">
            <div className="flex items-center justify-between">
                <span
                    className={`text-base ${returnDate ? "font-semibold text-gray-900 dark:text-gray-100" : "font-medium text-gray-400 dark:text-gray-500"
                        }`}
                >
                ...
                {returnDate ? (
                    ...
                    <HiOutlineCalendar className="w-5 h-5 text-gray-400 dark:text-gray-500 shrink-0" />
                )}
            </div>
        </Field>
    }
/>
                        ...
                        <div className="relative w-full lg:flex-[1.2] lg:min-w-0" ref={travelersRef}>
                            ...
                            >
                                <div className="flex items-center justify-between gap-2">
                                    <span className="text-base font-semibold text-gray-900 dark:text-gray-100 whitespace-nowrap truncate">
                                        {travelersSummary}
                                    </span>
                                    <HiOutlineUser className="w-5 h-5 text-gray-400 dark:text-gray-500 shrink-0" />
                                </div>
                            </Field>

                            {travelersOpen && (
                                <div className="absolute right-0 top-full mt-1.5 w-[320px] max-w-[92vw] bg-white dark:bg-gray-900 rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 p-3 z-50">
                                    <div className="flex items-center justify-between mb-2">
                                        <div className="flex items-center gap-1.5">
                                            <HiOutlineUserGroup className="w-4 h-4 text-gray-700 dark:text-gray-300" />
                                            <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">Travellers</span>
                                        </div>
                                        <button
                                            type="button"
                                    ...
                                    <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 mb-1.5">Cabin Class</p>
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`rounded-lg border px-2 py-1 text-left transition-colors ${selected
                                                            ...
                                                            : "bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 hover:border-gray-300 dark:hover:border-gray-600"
                                                        }`}
                                                >
                                                    <p className="text-xs font-semibold">{c.label}</p>
                                                    <p
                                                        className={`text-[10px] leading-tight ${selected ? "text-white/85" : "text-gray-500 dark:text-gray-400"
                                                            }`}
                                                    >
                                                        {c.desc}
                                                    </p>
                    ...
                    <div className="mt-9 flex flex-col lg:flex-row lg:items-end justify-between gap-8">
                        <div className="flex flex-col gap-5">
                            <div>
                                <p className="text-xs font-medium text-gray-500 dark:text-gray-400 mb-2">Flight Type</p>
 ...
 <div className="flex items-center flex-wrap gap-2">
    <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">Special Fares</span>
    <span className="text-xs text-gray-400 dark:text-gray-500 mr-1">(Optional)</span>
    {SPECIAL_FARES.map((f) => {
            ...
            >
                ...
                {hoveredFare === f.key && (
                    <div className="absolute left-0 top-full mt-2 z-50 w-64 animate-in fade-in duration-150">
                        <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 px-4 py-3 flex items-start gap-2">
                            <span className="absolute -top-1.5 left-6 w-3 h-3 bg-white dark:bg-gray-900 border-l border-t border-gray-100 dark:border-gray-800 rotate-45" />
                            ...
                            <p className="text-sm font-medium text-red-500 dark:text-red-400 leading-snug">
                        ...
                        <div className="flex flex-col items-end gap-2 shrink-0">
                            {searchError && (
                                <p className="text-sm text-red-600 dark:text-red-400 max-w-xs text-right">{searchError}</p>
                            )}
                            {!canSearch && (
...
function RadioPill({ label, checked, onClick }: { label: string; checked: boolean; onClick: () => void }) {
    return (
        <button type="button" onClick={onClick} className="flex items-center gap-2">
            <span
                className={`w-[18px] h-[18px] rounded-full border-2 flex items-center justify-center ${checked ? "border-[#FF7626]" : "border-gray-300 dark:border-gray-600"
                    }`}
            >
...
const Field = forwardRef<HTMLDivElement, FieldProps>(function Field(
    ...
    return (
        <div className="w-full">
            <p className="text-sm font-medium text-gray-600 dark:text-gray-300 mb-1.5 whitespace-nowrap">{label}</p>
            <div
                ref={ref}
                {...rest}
                className={`bg-gray-50 dark:bg-gray-900 border rounded-xl px-5 py-3.5 transition-colors ${active ? "border-[#1c8fc7] ring-2 ring-[#1c8fc7]/20" : "border-gray-200 dark:border-gray-700"
...
function AirportDropdown({ loading, results, query, error, onSelect }: AirportDropdownProps) {
    return (
        <div className="airport-scrollbar absolute left-0 right-0 top-full mt-2 min-w-full w-[370px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 max-h-72 overflow-y-auto z-50">
            {loading && (
                <div className="flex items-center gap-2 px-4 py-3 text-sm text-gray-400 dark:text-gray-500">
                    <span className="h-3.5 w-3.5 rounded-full border-2 border-gray-300 dark:border-gray-600 border-t-[#1c8fc7] animate-spin" />
                    Searching airports...
                </div>
            )}
            ...
            {!loading && !error && results.length === 0 && (
                <div className="px-4 py-3 text-sm text-gray-400 dark:text-gray-500">No airports found for &ldquo;{query}&rdquo;</div>
            )}
    ...
    <button
        ...
        onClick={() => onSelect(airport)}
                        ...
                        >
                            <span className="w-11 h-11 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm font-bold flex items-center justify-center shrink-0">
                                {airport.AirportCode}
                            </span>
                            <div className="min-w-0">
                                ...
                                <p className="text-xs text-gray-400 dark:text-gray-500 truncate">{airport.AirportName}</p>
                            </div>
                        </button>
                    ))}
                </div>
    ...
    return (
        <div className="mb-1.5">
            <p className="text-xs font-semibold text-gray-900 dark:text-gray-100 leading-tight">
                {title}
                {titleSuffix && <span className="font-normal text-gray-400 dark:text-gray-500 ml-0.5 text-[10px]">{titleSuffix}</span>}
            </p>
            <p className="text-[10px] text-gray-400 dark:text-gray-500 mb-1">{subtitle}</p>
