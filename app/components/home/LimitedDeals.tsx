...
function DealCard({ badge, title, description, code }: Deal) {
    return (
        <div className="bg-white rounded-2xl border border-gray-200 p-5 flex flex-col hover:shadow-md hover:border-gray-300 transition-shadow">
            ...
            <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                <div>
                    <p className="text-[10px] font-medium text-gray-400 tracking-wide">CODE</p>
                    <p className="text-sm font-bold text-gray-900">{code}</p>
                </div>
                <button
                    type="button"
                    aria-label={`Use code ${code}`}
                    className="grid place-items-center w-8 h-8 rounded-full text-gray-400 hover:text-[#FF7626] hover:bg-gray-50 transition-colors"
                >
