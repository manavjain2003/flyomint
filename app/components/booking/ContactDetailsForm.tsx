...
export default function ContactDetailsForm({
    ...
    // Pick up profile values once they arrive (e.g. after login/profile fetch resolves)
    useEffect(() => {
    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-200 p-5">
            <div className="flex items-center justify-between mb-1">
                ...
                {loading && <span className="text-xs text-gray-400">Fetching your details...</span>}
            </div>

            {fetchedName && (
                <p className="text-xs text-gray-400 mb-4">
                    Booking confirmation will be sent to{" "}
                    <span className="font-semibold text-gray-600">{fetchedName}</span>
                </p>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-4 mb-4">
                <div>
                    ...
                    <select
                        ...
                        className="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1c8fc7]/20 focus:border-[#1c8fc7]"
                    >
                        {COUNTRY_CODES.map((c) => (
                ...
                <div>
                    ...
                    <input
                        ...
                        maxLength={12}
                        className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#1c8fc7]/20 focus:border-[#1c8fc7]"
                    />
                </div>
            </div>
