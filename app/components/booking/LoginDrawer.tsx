            ...
            <div className="fixed inset-y-0 right-0 z-[70] w-full max-w-md bg-white shadow-2xl flex flex-col">
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    ...
                    <button
                        ...
                        onClick={handleClose}
                        aria-label="Close"
                        className="w-9 h-9 rounded-full hover:bg-gray-100 grid place-items-center text-gray-400 hover:text-gray-600 transition"
                    >
                    ...
                    {step === "mobile" && (
                        <form onSubmit={handleSendOtp} className="space-y-4">
                            <input
                                ...
                                className="w-full h-[52px] px-5 rounded-full border border-gray-200 text-[15px] text-gray-900 placeholder:text-gray-400 outline-none focus:border-[#FF7626]"
                            />
                                ...
                                {otpDigits.map((digit, index) => (
                                    <input
                                        ...
                                        className={`w-12 h-14 text-center text-xl font-semibold rounded-2xl border outline-none transition-colors
                                            ${invalidOtp
                                                ? "border-red-400 text-red-600 focus:border-red-500 focus:ring-2 focus:ring-red-500/20"
                                                : "border-gray-200 text-gray-900 focus:border-[#FF7626] focus:ring-2 focus:ring-[#FF7626]/20"}`}
                                    />
                                ))}
                            </div>
