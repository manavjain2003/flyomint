...
export default function FlightCard({
    ...
    return (
       <div
           className={`relative rounded-2xl border border-[#FF7626] overflow-hidden bg-white ${
    ...
    !directBooking ? "hover:bg-gray-50 transition-colors" : ""
}`}
             >
...
<div className="w-[100px] shrink-0">
   <p
  className="text-[18px] font-bold text-gray-900 leading-tight truncate"
  title={firstSeg?.AirlineName}
>
  {firstSeg?.AirlineName}
</p>
    <p className="text-[16px] text-gray-400 leading-tight break-words">
