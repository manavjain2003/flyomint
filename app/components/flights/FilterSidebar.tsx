...
export default function FilterSidebar({
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl sticky top-4 max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 filter-scrollbar">
                {/* Price Range */}
                <div className="mb-5">
