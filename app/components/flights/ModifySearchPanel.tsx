...
const [hoveredFare, setHoveredFare] = useState<Exclude<SpecialFare, "regular"> | null>(null);
    ...
    return (
        <div className="max-w-8xl mx-auto px-4 sm:px-6 pb-5">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm p-4 sm:p-5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-6 gap-3 items-end">
                    ...
                    <div className="col-span-2 md:col-span-2 relative grid grid-cols-2 gap-3">
                        ...
                        <div className="relative" ref={fromRef}>
                            <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">From</p>
                            <div
                                onClick={() => setFromOpen(true)}
                                className={`w-full h-10 rounded-lg border px-3 flex items-center cursor-text transition-colors ${fromOpen ? "border-[#1c8fc7] ring-2 ring-[#1c8fc7]/20" : "border-gray-200 dark:border-gray-700"
                                    }`}
                            >
                                <input
                        ...
                        <div className="relative" ref={toRef}>
                            <p className="text-[11px] font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">To</p>
                            <div
                                onClick={() => setToOpen(true)}
                                className={`w-full h-10 rounded-lg border px-3 flex items-center cursor-text transition-colors ${toOpen ? "border-[#1c8fc7] ring-2 ring-[#1c8fc7]/20" : "border-gray-200 dark:border-gray-700"
                                    }`}
                            >
                                <input
                        ...
                        <button
                            ...
                            className="hidden md:grid absolute left-1/2 top-6 -translate-x-1/2 z-20 place-items-center w-7 h-7 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-400 dark:text-gray-500 hover:text-[#1c8fc7] hover:border-[#1c8fc7] shadow-sm"
                        >
...
<div className={`col-span-1 ${draft.tripType === "roundtrip" ? "" : "opacity-50"}`}>
    ...
    />
                    ...
                    <div className="col-span-2 md:col-span-1 relative" ref={travelersRef}>
                        ...
                        <button
                            ...
                            className="w-full h-10 rounded-lg border border-gray-200 dark:border-gray-700 px-3 text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center justify-between gap-1"
                        >
                            <span className="truncate">
                                {totalTravelers} &bull; {CABIN_LABEL[draft.cabinClass]}
                            </span>
                            <HiOutlineChevronDown className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 shrink-0" />
                        </button>

                        {travelersOpen && (
                            <div className="absolute z-20 top-full mt-2 right-0 w-[320px] max-w-[92vw] bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-lg p-3">
                ...
                <div className="col-span-2 md:col-span-1 relative">
                        <button
                            type="button"
                            onClick={onCancel}
                            className="h-10 px-5 rounded-full text-sm font-semibold text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
                        >
                            Cancel
                        </button>
                        <button
    ...
    <span className="text-xs font-medium text-gray-500 dark:text-gray-400 mr-1">Special fare:</span>
...
>(function ModifyDateInput({ value, onClick, placeholder, onClear }, ref) {
    return (
        <button
            ...
            ref={ref}
            onClick={onClick}
            className="w-full h-10 rounded-lg border border-gray-200 dark:border-gray-700 px-3 text-sm font-semibold text-left flex items-center justify-between focus:outline-none focus:border-[#1c8fc7] disabled:cursor-not-allowed disabled:opacity-60"
        >
             ...
             <div className="flex items-center gap-1">
                {value && onClear && (
                    <span
                        ...
                        className="p-0.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 cursor-pointer"
                    >
...
function ModifySearchAirportDropdown({
    ...
    return (
        <div className="absolute left-0 right-0 top-full mt-2 min-w-[260px] bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 max-h-64 overflow-y-auto z-50">
            {loading && (
            ...
            {!loading && error && <div className="px-4 py-3 text-sm text-red-600 dark:text-red-400">{error}</div>}
            ...
            {!loading && (
                <div className="divide-y divide-gray-100 dark:divide-gray-800">
                    {results.map((airport) => (
                        ...
                        >
                            <span className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-xs font-bold flex items-center justify-center shrink-0">
                                {airport.AirportCode}
                            </span>
